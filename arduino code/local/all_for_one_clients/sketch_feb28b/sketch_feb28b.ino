...
const char* serverIP = "192.168.43.235"; // Gateway ESP32 IP
...
void setup() {
  ...
  // Set dynamic client ID using MAC address
  clientId = "ESP32_" + WiFi.macAddress();
  clientId.replace(":", ""); // Remove colons for cleaner ID
...
void loop() {
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    double latitude = 0.0, longitude = 0.0; // Real GPS - 0.0 indoors
    String timestamp = "";
    int gpsIterations = 0;
